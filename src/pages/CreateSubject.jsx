...
import { useNavigate } from "react-router-dom";
 ...
 function CreateSubject() {
  ...
  const validateFormData = (data) => {
    ...
    // Check for duplicate courseCode in temporary subjects list
    if (
      data.courseCode &&
      subjects.some(
        (subject) =>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <button
          onClick={() => navigate("/post-subjects")} // Updated navigation path
          ...
          <div className="mt-8 bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
                ...
                <button
                  onClick={handleSave}
                  className="bg-blue-500 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transform transition-all duration-300 hover:scale-105 flex items-center space-x-2"
                >
                  <FaSave />
